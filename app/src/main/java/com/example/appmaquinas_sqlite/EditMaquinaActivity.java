...
public class EditMaquinaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fec_ult.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        EditMaquinaActivity.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        if (savedInstanceState == null) {
            ...
            DbMaquinas dbMaquinas = new DbMaquinas(EditMaquinaActivity.this);
            ...
            if (maquinas != null) {
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        correcto = dbMaquinas.UpdateMaq(id, maquina.getText().toString(),ubicacion.getText().toString(),spinner.getSelectedItem().toString(), fec_ult.getText().toString(),fec_pro.getText().toString(),spinner2.getSelectedItem().toString());
                        if (correcto) {
                            Toast.makeText(EditMaquinaActivity.this, "REGISTRO MODIFICADO", Toast.LENGTH_SHORT).show();
                            lista();
                        } else {
                            Toast.makeText(EditMaquinaActivity.this, "ERROR AL MODIFICAR", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
